...
function Cart() {
  ...
  return (
    <div className="absolute top-14 right-2 z-20">
      <div
        className="relative w-screen max-w-sm border rounded-sm border-gray-400 bg-gray-100 px-4 py-8 sm:px-6 lg:px-8"
        aria-modal="true"
        role="dialog"
        tabIndex="-1"
      >
                ...
                <li className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <dl className="mt-0.5 space-y-px text-[10px] text-gray-600">
                      <div>
                        <p className="inline">{item?.product?.attributes?.category}</p>
                      </div>
